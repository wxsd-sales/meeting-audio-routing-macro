...
flowchart LR
 ...
 subgraph subGraph3["Meeting Room"]
    ...
    webex["Webex Meeting"] e1@== Audio Stream ==> RA1 & RA2 & RA3 & RA4 & RA5
    RA1 L_RA1_LSG_0@==> LSG
    RA2 L_RA2_LSG_0@==> LSG
    RA3 L_RA3_LSG_0@==> LSG
    RA4 L_RA4_PAG_0@==> PAG
...
- RoomOS 11.31.x or above Webex Device.
- Web admin access to the device to upload the macro.


### Installation Steps:
1. Download the ``meeting-audio-routing.js`` file and upload it to your Webex Room devices Macro editor via the web interface.
