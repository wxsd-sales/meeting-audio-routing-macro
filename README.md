...
This is an example macro which routes incoming Remote Audio Inputs from a Webex Meeting out specific Audio outputs when joined from a Cisco Collab Device
